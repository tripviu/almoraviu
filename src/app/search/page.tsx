      ...
      <main className="py-8">
        <Container>
          <div className="flex items-end justify-between gap-4">
            <div>
              <h1 className="text-2xl font-semibold mb-1">Results {searchParams.city ? `for “${searchParams.city}”` : ""}</h1>
          ...
          {/* Filters */}
          <form action="/search" className="mt-4 mb-6 grid gap-3 md:grid-cols-8 bg-white p-4 rounded-xl border shadow-sm">
