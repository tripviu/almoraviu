            ...
            <form action="/search" className="mt-8 grid gap-3 md:grid-cols-6 bg-white p-4 rounded-xl border shadow-sm">
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input name="city" placeholder="City or destination (e.g., Dubai)" className="w-full border rounded pl-9 pr-3 py-2" required />
                </div>
              </div>
              ...
              <div className="md:col-span-6">
                <button className="w-full bg-black text-white rounded px-4 py-3 hover:opacity-90">Search</button>
              </div>
            </form>
          </div>
        </Container>
