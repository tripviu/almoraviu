      ...
      typography: ({ theme }) => ({
        tripviu: {
          css: {
            ...
            "--tw-prose-links": theme("colors.tripviu.brand"),
            "--tw-prose-bold": theme("colors.gray.900"),
            "--tw-prose-counters": theme("colors.gray.600"),
            "--tw-prose-bullets": theme("colors.gray.400"),
            "--tw-prose-hr": theme("colors.gray.200"),
            "--tw-prose-quotes": theme("colors.gray.900"),
            "--tw-prose-quote-borders": theme("colors.tripviu.gold"),
            ...
            a: { textDecoration: "none", borderBottom: `1px solid ${theme("colors.tripviu.brand")}` },
            "a:hover": { opacity: .85 },
            ...
            blockquote: { borderLeftColor: theme("colors.tripviu.gold"), backgroundColor: "#fffef8" },
